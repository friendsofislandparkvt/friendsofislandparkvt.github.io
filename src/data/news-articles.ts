...
export const newsArticles: NewsArticle[] = [
    {
        ...
        body: 'Friends of Island Park presented the Riverfront Connections: Art Show and Historical Retrospective at the Latchis Gallery, featuring works from artists inspired by the beauty of the river, bridge, and island at the south end of downtown Brattleboro. The well-attended event was enjoyed by many art and river enthusiasts.\n\nThe exhibition celebrated the history and current state of Island Park, showcasing historical documents and photos from the Brattleboro Historical Society, including a four-panel mural celebrating the history of the circus on the island.',
        pullQuote:
